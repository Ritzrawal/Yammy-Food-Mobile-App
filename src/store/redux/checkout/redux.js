...
const nativePaymentMethod = [
  {
    ...
    // iconSource: AppStyles.iconSet.cashpay,
  ...
  },
  {
    ...
    key: 'Paypal',
    last4: 'Paypal',
    // iconSource: AppStyles.iconSet.paypal,
    isCashOnDelivery: true,
  },
];
...
const checkoutInitialState = {
  ...
  selectedPaymentMethod: nativePaymentMethod[0],
};
...
export const checkout = (state = checkoutInitialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_SHIPPING_ADDRESS:
      console.log('hello ship', action.data);
      return {
        ...state,
...
const updateUserPaymentMethods = (state, methods) => {
  console.log('hello payment', nativePaymentMethod);
